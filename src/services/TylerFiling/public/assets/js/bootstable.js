...
var colsEdi =null;
var newColHtml = '<div class="btn-group text-end">'+
'<button id="bEdit" type="button" class="btn btn-sm btn-default bg-dark text-white" onclick="butRowEdit(this);">' +
'<span class="glyphicon glyphicon-pencil" >Edit </span>'+
'</button>'+
'<button id="bElim" type="button" class="btn btn-sm btn-default bg-dark text-white" onclick="butRowDelete(this);">' +
'<span class="glyphicon glyphicon-trash" > Delete</span>'+
'</button>'+
'<button id="bAcep" type="button" class="btn btn-sm btn-default bg-dark text-white" style="display:none;" onclick="butRowAcep(this);">' + 
'<span class="glyphicon glyphicon-ok" > Ok</span>'+
'</button>'+
'<button id="bCanc" type="button" class="btn btn-sm btn-default bg-dark text-white" style="display:none;" onclick="butRowCancel(this);">' + 
'<span class="glyphicon glyphicon-remove" >Remove </span>'+
'</button>'+
  '</div>';
  //Case NOT Bootstrap
  var newColHtml2 = '<div class="btn-group text-end">'+
  '<button id="bEdit" type="button" class="btn btn-sm btn-default bg-dark text-white" onclick="butRowEdit(this);">' +
  '<span class="glyphicon glyphicon-pencil" > Edit </span>'+
  '</button>'+
  '<button id="bElim" type="button" class="btn btn-sm btn-default bg-dark text-white" onclick="butRowDelete(this);">' +
