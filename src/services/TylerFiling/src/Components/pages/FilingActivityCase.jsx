                    ...
                    <div className="row container ps-lg-4 ps-md-4 ps-sm-4 pe-0">
                        <div className="row mt-3">
                            <div className="d-flex align-items-center justify-content-between align-items-center initiate_case_sec_btn pe-0">
                                ...
                                > Filing Activity by Case Report
                                </h1>
                            </div>
                        </div>
                        {/* tip data */}
                        ...
                        <form method="post">
                            <div className="row mt-2 gx-3 gy-4">
                                ...
                                <div className="col-12 col-md-6">
                                    ...
                                    {/* Invoice ID */}
                                    <div className="row mb-3">
                                        <label htmlFor="invoice_id" className="col-sm-4 col-form-label fw-bold">Invoice ID</label>
                                        <div className="col-sm-8">
                                            <input
                                                type="text"
                                                className="form-control"
                                    ...
                                    {/* Case No */}
                                    <div className="row mb-3">
                                        <label htmlFor="case_no" className="col-sm-4 col-form-label fw-bold">Case No</label>
                                        <div className="col-sm-8">
                                            <input
                                                type="text"
                                                className="form-control"
...
export default FilingActivityCase;