...
function EditForm() {
    ...
    const handleSelectChange = (selectedOption, field) => {
        ...
        // ✅ Specifically update selectedCategory state
        if (field === "selectedCategory") {
            setSelectedCategoryState(value); // or setSelectedCategoryState(value) if you prefer just the value
        }

        console.log("Selected value after state update:", value);
        console.log("Current selected category state:", selectedCategoryState);
    ...
    const handleDocumentTypeChange = async (selectedOption, index) => {
        ...
        setDraftValues((prev) => {
            ...
            updatedDocuments[index] = {
                ...
                // Initialize optionalServicesSelections if it's empty or undefined
                optionalServicesSelections: updatedDocuments[index].optionalServicesSelections || [{ value: '', label: '' }],
            };
    ...
    const handleAddDocument = () => {
        ...
        setDraftValues(prev => {
            ...
            setEditIndex(updatedDocs.length - 1); // Put new row in edit mode
            return {
                ...prev,
                                        ...
                                        <div className="card p-2">
                                            <div className="card-body">
                                                <div className="row">
                                                    {/* <!-- section 1 --> */}
                                                    {draftValues.caseNumber ? (
                                                        <div className="col-12 col-md-12 col-lg-12 mb-3" style={{ fontSize: "14px" }}>
                                                        ...
                                                        <div className="col-12 col-md-12 col-lg-12 mb-3" style={{ fontSize: "14px" }}>
                                                            <div className="section-case-bg border p-2 mb-0">
                                                                <p className="fw-bold mb-0" style={{ fontSize: "14px" }} >1. Select Court & Case Type -
                                                    ...
                                                    <div className="col-12 mb-3">
                                                        ...
                                                        <div className="border border-top-0 shadow rounded-bottom p-3">
                                                            ...
                                                            {(draftValues.selectedCategory || selectedCategoryState) ? (
                                                                                ...
                                                                                {editIndex === index || !document.documentType ? (
                                                                                    <>
                                                                                        <Select
                                                                                            ...
                                                                                            value={documentType.find(opt => String(opt.value) === String(document.documentType)) || null}
                                                                                    ...
                                                                                    <div>{documentType.find(opt => String(opt.value) === String(document.documentType))?.label || "N/A"}</div>
                                                                                )}
                                                                            </div>
                                                                            ...
                                                                            <div className="col-12 col-md-3 mb-2" style={{ fontSize: "14px" }}>
                                                                                ...
                                                                                {editIndex === index || !document.documentDescription ? (
                                                                                    <input
                                                                                        ...
                                                                                        onChange={(e) => {
                                                                                            const updatedDocs = [...(draftValues.documents || [])];
                                                                                            updatedDocs[index] = {
                                                                                                ...updatedDocs[index],
                                                                                                documentDescription: e.target.value,
                                                                                            };
                                                                                            setDraftValues({ ...draftValues, documents: updatedDocs });
                                                                                        }}
                                                                                ...
                                                                                {editIndex === index ? (
                                                                                    <>
                                                                                        <input
                                                                                            ...
                                                                                            className={`form-control ${formik.errors.documents?.[index]?.fileName ? "is-invalid" : ""}`}
                                                                                        />
                                                                                    ...
                                                                                    document?.fileName ? (
                                                                                        ...
                                                                                        >
                                                                                            {document.fileName} ({document.fileSize} kB, {document.pageCount} pg.)
                                                                                        </a>
                                                                                    ) : (
                                                                                    ...
                                                                                    <>
                                                                                        {document?.fileName ? (
                                                                                            <Link onClick={(e) => { e.preventDefault(); handleOpenPDF(formik.values.documents?.[index]); }}>
                                                                                                {document.fileName} ({document.fileSize}KB, {document.numPages})
                                                                                            </Link>
                                                                                        ) : (
                                                                                            <input
                                                                                                id={`file-upload-${index}`}
                                                                            ...
                                                                            <div className="col-12 col-md-3 mb-2 text-md-start" style={{ fontSize: "14px" }}>
                                                                                {editIndex === index ? (
                                                                                    <>
                                                                                        ...
                                                                                        <button className="btn btn-secondary btn-sm" onClick={(e) => handleCancel(e)}>Cancel</button>
                                                                                    </>
                                                                                ) : deleteIndex === index ? (
                                                                                    <>
                                                                                    ...
                                                                                    document?.fileName && (
                                                                                        <>
                                                                                            <button type="button" className="btn btn-dark btn-sm me-2" onClick={(e) => { e.preventDefault(); handleEdit(index, e); }}>
                                                                                                Edit
                                                                                            </button>
                                                                                            <button type="button" className="btn btn-dark btn-sm" onClick={(e) => { e.preventDefault(); handleDelete(index, e); }}>
                                                                                                Delete
                                                                                            </button>
                                                                                        </>
                                                                                    )
                                                    ...
                                                    <div className="col-12 mb-3">
                                                        ...
                                                        <div className="border border-top-0 shadow rounded-bottom p-3">
                                                            <div className="row mb-3">
                                                                {draftValues.documents?.some((document) => document.documentType) ? (
                                                                    <div className="w-100">
                                                                        {/* Header */}
                                                                        <div className="row fw-bold border-bottom pb-2 mb-2 d-none d-md-flex">
                                                                            <div className="col-md-3">Document</div>
                                                                            <div className="col-md-3">Security</div>
                                                                            <div className="col-md-3">Optional Services</div>
                                                                        ...
                                                                        {draftValues.documents.map((document, index) => {
                                                                            const selectedDocType = documentType.find(
                                                                                (option) => String(option.value) === String(document.documentType)
                                                                            );

                                                                            return (
                                                                                <div className="row mb-4 border-bottom pb-3" key={index} style={{ fontSize: "14px" }}>
                                                                                    {/* Document Name */}
                                                                                    <div className="col-12 col-md-3 mb-2">
                                                                                        <label className="d-block d-md-none fw-bold">Document</label>
                                                                                        <p className="mb-0">{selectedDocType ? selectedDocType.label : "No Document Type"}</p>
                                                                                    </div>
                                                                                            ...
                                                                                            document.optionalServicesSelections?.map((service, serviceIndex) => (
                                                                                                <div key={serviceIndex} className="mb-2">
                                                                                                    <Select
                                                                                                        ...
                                                                                                        value={
                                                                                                            optionalServicesOptions[index]?.find(
                                                                                                        ...
                                                                                                        className="optional-services-dropdown"
                                                                                                    />
                                                                                                </div>
                                                                                            ))}
                                                                                    </div>
                                                                    ...
                                                                    <p>Complete document upload to load security and available optional services.</p>
                                                                )}
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div className="border border-top-0 shadow rounded-bottom p-3">
                                                            {Array.isArray(draftValues.parties) &&
                                                                draftValues.parties.map((party, index) => (
                                                                    <div key={party.id} className="party-row position-relative border rounded p-3 mb-4 bg-white shadow-sm">

                                                                        {/* Remove Party Top Right */}
                                                                        <div style={{ position: "absolute", top: "10px", right: "10px" }}>
                                                                            ...
                                                                            >
                                                                                <i className="fa fa-times-circle fa-fw text-danger me-1"></i>
                                                                                Remove Party
                                                                            </Link>
                                                                        </div>
                                                                            ...
                                                                            <>
                                                                                <div className="row mb-3">
                                                                                    <div className="col-md-3">
                                                                                        ...
                                                                                        />
                                                                                        {formik.touched.parties?.[index]?.lastName &&
                                                                                            formik.errors.parties?.[index]?.lastName && (
                                                                                                <div className="text-danger mt-1">{formik.errors.parties[index].lastName}</div>
                                                                                            )}
                                                                                    </div>
                                                                                    <div className="col-md-3">
                                                                                        <label className="form-label fw-bold">
                                                                                        ...
                                                                                        />
                                                                                        {formik.touched.parties?.[index]?.firstName &&
                                                                                            formik.errors.parties?.[index]?.firstName && (
                                                                                                <div className="text-danger mt-1">{formik.errors.parties[index].firstName}</div>
                                                                                            )}
                                                                                    </div>
                                                                                    <div className="col-md-3">
                                                                        ...
                                                                        {party.roleType === "2" && (
                                                                            <div className="row g-3 mt-2">
                                                                                <div className="col-12 col-md-3">
                                                                                    ...
                                                                                    />
                                                                                    {formik.touched.parties?.[index]?.companyName &&
                                                                                        formik.errors.parties?.[index]?.companyName && (
                                                                        ...
                                                                        <div className="row g-3 mt-2">
                                                                            <div className="col-12 col-md-4">
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label fw-bold" htmlFor={`address_unknown_${party.id}`}>
                                                                                        Address Unknown
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div className="form-check">
                                                                                ...
                                                                                <label className="form-check-label fw-bold" htmlFor={`international_address_${party.id}`}>
                                                                            ...
                                                                            <div className="col-12 col-md-3">
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label fw-bold" htmlFor={`save_to_addressbook_${party.id}`}>
                                                                        ...
                                                                        <div className="row g-3 mt-4">
                                                                            <div className="col-12 col-md-3">
                                                                                <label className="form-label fw-bold">
                                                                                    ...
                                                                                    <i className="fa fa-asterisk text-danger small ms-1" />
                                                                                </label>
                                                                                <Select
                                                                                    value={
                                                    ...
                                                    <div className="col-12 mb-3">
                                                        ...
                                                        {/* Table Container */}
                                                        {(draftValues.caseNumber && combinedParties.length > 0) ||
                                                                                ...
                                                                                <table className="table table-bordered align-middle mb-0">
                                                                                    <thead className="table-light">
                                                                                        <tr className="fw-bold text-nowrap">
                                                                                            ...
                                                                                            <th style={{ minWidth: "150px" }}>Party Name</th>
                                                                                            <th style={{ minWidth: "120px" }}>Party Type</th>
                                                                                            ...
                                                                                            <tr key={party.id}>
                                                                                                <td className="text-center">
                                                                                                    <input
                                                                                                        ...
                                                                                                        type="checkbox"
                                                                                                        checked={
                                                                                                            selectedParties.find((p) => p.id === party.id)?.isChecked || false
                                                                                                        }
                                                                                                ...
                                                                                                <td>
                                                                                                    {party.selectedPartyType
                                                                                                        ? partyTypes.find((type) => type.value === party.selectedPartyType)
                                                                                                            ?.label ||
                                                                    ...
                                                                    <div className="row mb-3">
                                                                        <div className="table-responsive">
                                                                            <table className="table table-bordered align-middle mb-0">
                                                                                ...
                                                                                <tbody>
                                                                                    {draftValues.selectedParties?.length > 0 ? (
                                                                                        draftValues.selectedParties.map((party) => (
                                                                                            <tr key={party.id}>
                                                                                                <td className="text-center">
                                                                                                    <input
                                                        ...
                                                        <div className="border border-top-0 shadow rounded-bottom p-3">
                                                            {draftValues.caseNumber ? (
                                                                            ...
                                                                            <div key={index} className="mb-4">
                                                                                <div className="table-responsive">
                                                                                    <table className="table table-borderless">
                                                                                        <tbody>
                                                                                            <tr className="info border mb-3 p-2">
                                                                                            ...
                                                                                            {document.optionalServicesSelections?.map((service, serviceIndex) => (
                                                                                                <tr key={serviceIndex}>
                                                                                                    <td>
                                                                                                        {service.label}
                                                                                                        {service.multiplier && service.Quantity > 0 ? ` (x ${service.Quantity})` : ""}
                                                                                                    </td>
                                                                                                    <td className="text-end w150">
                                                                                                    ...
                                                                                                    {(() => {
                                                                                                        ...
                                                                                                        if (document.optionalServicesSelections) {
                                                                                                            total += document.optionalServicesSelections.reduce((acc, service) => {
                                                                                                                ...
                                                                                                                return typeof service.fee === "number"
                                                                                                                    ? acc + service.fee * quantity
                                                                                                                    : acc;
                                                                                                            }, 0);
                                                                                                        }
                                                                        ...
                                                                        {caseInitiationFee && (
                                                                            <>
                                                                                <div className="row mb-2 p-2">
                                                                                    <p className="col-6 text-muted text-start mb-0">{caseInitiationFee.reason}</p>
                                                                                    <p className="col-6 text-muted text-end mb-0">{caseInitiationFee.amount} USD</p>
                                                                                </div>
                                                                                <div className="row mb-2 p-2">
                                                                                    <p className="col-10 text-end mb-0">Sub-Total</p>
                                                                                    <p className="col-2 fw-bold text-end mb-0">{caseInitiationFee.amount} USD</p>
                                                                                </div>
                                                                            </>
                                                                        )}
                                                                    </div>

                                                                    <div className="fee-section-item mt-4">
                                                                        <div className="table-responsive">
                                                                            <table className="table">
                                                                                ...
                                                                                <tbody>
                                                                                    {feesdata?.AllowanceCharge?.filter(charge =>
                                                                                        !["Case Initiation Fee", "Filing Fee", "Optional Service Fee"].includes(charge.AllowanceChargeReason?.Value) &&
                                                                                        ...
                                                                                        <tr key={index}>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td colSpan="2" className="text-center">No allowance charges available</td>
                                                                                            </tr>
                                                                                        )}
                                                                ...
                                                                <div className="container-fluid px-4">
                                                                    {/* Fallback for no case number */}
                                                                    <div className="row fee-section-item">
                                                                        <div className="row border mb-3 shadow p-2">
                                                                            {selectedCaseType && (
                                                                                <p className="col-6 fw-bold text-start mb-0">{selectedCaseType.label}</p>
                                                                            )}
                                                                            <p className="col-6 fw-bold text-end mb-0">Estimated Fees</p>
                                                                        </div>
                                                                        ...
                                                                        {caseInitiationFee && (
                                                                            <>
                                                                                ...
                                                                                <div className="row p-2">
                                                                                    <p className="col-12 col-md-10 text-end mb-0">Sub-Total</p>
                                                                                    <p className="col-12 col-md-2 fw-bold text-end mb-0">{caseInitiationFee.amount} USD</p>
                                                                                </div>
                                                                            </>
                                                                        )}
                                                                    </div>
                                                                    ...
                                                                    <div className="row fee-section-item">
                                                                        <div className="row border shadow p-2">
                                                                            <p className="col-6 fw-bold text-start mb-0">Service Fees</p>
                                                                            <p className="col-6 fw-bold text-end mb-0">Estimated Fees</p>
                                                                        </div>
                                                                        ...
                                                                        {otherFees?.length > 0 ? (
                                                                            otherFees.map((fee, index) => (
                                                                                <div className="row p-2" key={index}>
                                                                                    <p className="col-6 text-muted text-start mb-0">{fee.reason}</p>
                                                                                    <p className="col-6 text-muted text-end mb-0">{fee.amount} USD</p>
                                                                                </div>
                                                                            ))
                                                                        ) : (
                                                                            <p className="text-center text-muted mt-2">No other fees available</p>
                                                                        )}

                                                                        <div className="row p-2 border-top">
                                                                            <p className="col-12 col-md-8 mb-0"></p>
                                                                            <p className="col-12 col-md-2 fw-bold text-end mb-0">Grand Total</p>
                                                                            <p className="col-12 col-md-2 fw-bold text-end mb-0">{feesCalculationAmount} USD</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="container-fluid mt-3 mb-3">
                                                                <div className="row g-3 align-items-center">
                                                                    ...
                                                                    <div className="col-12 col-md-4 col-lg-3">
                                                                        <label htmlFor="paymentAccount" className="form-label fw-bold mb-0">
                                                                            Select Payment Account
                                                                            <i
                                                                                className="fa fa-asterisk"
                                                                                aria-hidden="true"
                                                                                style={{ color: "red", fontSize: "8px", verticalAlign: "top" }}
                                                                            ></i>
                                                                        </label>
                                                                    </div>
                                                                    ...
                                                                    <div className="col-12 col-md-5 col-lg-4">
                                                                        <Select
                                                                            ...
                                                                            value={paymentAccountOptions.find((option) => option.value === draftValues?.paymentAccount) || null}
                                                                            onChange={(selectedOption) => handleSelectChange(selectedOption, "paymentAccount")}
                                                                            isSearchable
                                                                    ...
                                                                    <div className="col-12 col-md-3 col-lg-5 text-md-end">
                                                                        <Link
                                                                            className="btn btn-link fw-bold px-0"
                                                                            onClick={(e) => {
                                                                                e.preventDefault();
                                                    ...
                                                    <div className="col-12 mb-3" style={{ fontSize: "14px" }}>
                                                        ...
                                                        <div className="border border-top-0 shadow rounded-bottom p-3">
                                                            <div className="row mb-3">
                                                                <div className="col-12 col-md-3 fw-bold">Filing for</div>
                                                            ...
                                                            <div className="row mb-3">
                                                                <div className="col-12 col-md-3 fw-bold">Courtesy Email Notice</div>
                                                                <div className="col-12 col-md-9">
                                                                    <input
                                                                        name="courtesyemail"
                                                                        className="form-control"
                                                            ...
                                                            {/* Note to clerk */}
                                                            <div className="row mb-3">
                                                                <div className="col-12 col-md-3 fw-bold">Note to clerk</div>
                                                                <div className="col-12 col-md-9">
                                                                    <textarea
                                                                        name="note"
                                                                        className="form-control"
