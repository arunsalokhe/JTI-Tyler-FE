                    ...
                    <div className="row container ps-lg-4 ps-md-4 ps-sm-4 pe-0">
                        ...
                        <div className="d-flex align-content-center mt-3 mb-3">
                            ...
                            <div className="d-flex initiate_case_sec_btn">
                                <a href="#" className="custom-link mx-2 mb-2" onClick={(e) => { e.preventDefault(); }}>
                        ...
                        <div className="col-12 col-md-12 col-xl-12 align-items-center">
                            <div
                                ...
                                style={{
                                    ...
                                    padding: "10px",
                                    borderRadius: "5px",
                                    maxWidth: "98%", // Ensures it doesn't overflow
                                }}
                            >
                        ...
                        {/* <div className="border mb-3 mt-1 align-items-center p-2" style={{ backgroundColor: "#916AAB4D" }}>
                            <span className=" fw-bold mb-0">Serve Only</span> <span className=" mb-0">- Complete the below filing steps and submit to serve your documents.</span>
                        </div> */}
                        {/* <!-- form sections --> */}
                                    ...
                                    <div className="card p-2">
                                        <div className="card-body">
                                            <div className="row">
                                                ...
                                                <div className="col-12 col-md-12 col-lg-12 mb-3">
                                                    <div className="section-case-bg row border mb-3 shadow align-items-center p-2">
                                                        <p className="fw-bold mb-0">2 . Add Documents
                                                            <span className='fw-normal' style={{ fontSize: "16px" }}> - Define, select, and upload the documents that make up your filing.</span></p>
                                                    </div>
                                                    {selectedCaseDetails ? (
                                                        <div className="row mb-3">
                                                            <div className="col-sm-12">
                                                                <table className="table table-borderless table-responsive " id="table-list">
                                                                    <thead className="border-bottom">
                                                                        <tr>
                                                                            <th style={{ width: "200px", whiteSpace: "nowrap" }}>Document Type</th>
                                                                            <th style={{ width: "300px", whiteSpace: "nowrap" }}>Document Description</th>
                                                                            <th style={{ width: "250px", whiteSpace: "nowrap" }}>File Name</th>
                                                                                    ...
                                                                                    {editIndex === index ? (
                                                                                        ...
                                                                                        <>
                                                                                            <a
                                                                                                href="#"
                                                                                                className="btn btn-dark"
                                                                                                style={{ fontSize: "14px", padding: "5px 8px", marginRight: "5px", textDecoration: "none" }}
                                                                                                onClick={(e) => {
                                                ...
                                                <div className="col-12 col-md-12 col-lg-12 mb-3">
                                                    <div className="section-case-bg row border mb-3 shadow align-items-center p-2">
                                                        <p className="fw-bold mb-0"> 3 . Filing Party
                                                            <span className='fw-normal' style={{ fontSize: "16px" }}> - Choose the party or parties you are filing on behalf of. If using a keyboard, select parties with the enter key instead of the spacebar.</span> </p>
                                                    </div>
                                                    {selectedCaseTypeId ? (
                                                        <div>
                                                            {selectedParties.length > 0 && (
                                                                <div className="row mb-3">
                                                                    <table className="table table-borderless table-responsive justify-content-center">
                                                                        <tbody>
                                                                            <tr className="fw-bold border-bottom"> {/* Added 'border-bottom' class */}
                                                                                <td>
                                                                                    <input
                                                                                        name='checkboxItems'
                                                                                        type="checkbox"
                                                                            ...
                                                                            {combinedParties.map((party) => (
                                                                                <tr key={party.id} className="border-bottom"> {/* Added 'border-bottom' class */}
                                                                                    <td>
                                                                                        <input
                                                                                    ...
                                                                                    <td>
                                                                                        {party.selectedPartyType ? (
                                                                                            ...
                                                                                            PartyTypeMapping[party.selectedPartyType] || "N/A"
                                                                                        ) : (
                                                                                            "N/A"
                                                                                        )}
                                                                                    </td>
                                                ...
                                                <div className="col-12 col-md-12 col-lg-12 mb-3">
                                                    <div className="section-case-bg row border mb-3 shadow align-items-center p-2">
                                                        <p className="fw-bold mb-0"> 4 . Postage & Handling
                                                            <span className='fw-normal' style={{ fontSize: "16px" }}> - Mail Service fees paid separately from fees.</span>
                                                        </p>
                                                    </div>
                                                    <div className="table-responsive">
                                                        <table aria-label="Postage and Handling Fees" className="table">
                                                            <colgroup>
                                                                <col />
                                                            </colgroup>
                                                            <tbody>
                                                                {/* Header Row */}
                                                                <tr className="text-bold" style={{ backgroundColor: "#f5f5f5" }}>
                                                                    <td aria-label="Service Fees column header">Service Fees</td>
                                                                    <td aria-label="Estimated column header" className="text-right">Estimated</td>
                                                                </tr>

                                                                {/* Mail Service Fees Row */}
                                                                <tr>
                                                                    <td aria-label="Mail Service Fees">Mail Service Fees</td>
                                                                    <td aria-label="$0.00" className="text-right">$0.00</td>
                                                                </tr>
                                                                {/* Convenience Fee Row */}
                                                                <tr>
                                                                    <td aria-label="Convenience Fee">Convenience Fee</td>
                                                                    <td aria-label="$0.00" className="text-right">$0.00</td>
                                                                </tr>
                                                                {/* Sub-Total Row */}
                                                                <tr>
                                                                    <td aria-label="Sub-Total" className="text-center text-bold">Sub-Total</td>
                                                                    <td aria-label="$0.00" className="text-right text-bold">$0.00</td>
                                                                </tr>
                                                    ...
                                                    <div className="row mb-3 pt-3 align-items-center">
                                                        <label className="col-auto fw-bold pe-0 text-nowrap me-4">
                                                        ...
                                                        <div className="col">
                                                            <Select
                                                                ...
                                                                styles={{
                                                                    ...
                                                                    menu: (provided) => ({
                                                                        ...provided,
                                                                        minWidth: "200px",  // 🔹 Ensures the dropdown options match
                                                                        maxWidth: "250px",
                                                                    }),
                                                                    menuList: (provided) => ({
                                                                        ...provided,
                                                                        width: "100%",  // 🔹 Forces dropdown list to take full width
                                                                    })
                                                                }}
                                                            />
                                                ...
                                                <div className="col-12 col-md-12 col-lg-12 mb-3">
                                                    <div className="section-case-bg row border mb-3 shadow align-items-center p-2">
                                                        <p className="fw-bold mb-0"> 5 . Review & Submit
                                                            <span className='fw-normal' style={{ fontSize: "16px" }}> - Finalize your submission, review, and submit.</span>
                                                        </p>
                                                    </div>
                                                    <div className="row mb-3" >
                                                        <table className="table table-borderless table-responsive justify-content-center">
                                                            <tbody>
                                                                <tr>
                                                                    <td className="fw-bold" style={{ width: "10%" }}>Created by</td>
                                                                    <td style={{ width: "30%" }}>
                                                                        <input
                                                                            name="createdBy"
                                                                            className="form-control"
                                                                            type="text"
                                                                            value={formik.values.createdBy} // 🔹 Auto-updates when API data arrives
                                                                            readOnly // 🔹 Non-editable
                                                                            style={{
                                                                                backgroundColor: "#e9ecef", // 🔹 Light gray background for read-only
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td >
                                                                        <div className="form-check">
                                                                            ...
                                                                            <label className="form-check-label" htmlFor="verifyCheckbox"> I have verified my service information, and understand I am submitting these documents for SERVICE ONLY, and that they will not be filed with the Court.
                                                                        ...
                                                                        {/* <div className="col-lg-10 label-fw400">
                                                                            <span
                                                                            ...
                                                                            >                                                                                
                                                                                <i
                                                                                    className={`fa ${isChecked ? "fa-check-square-o" : "fa-square-o"} fa-fw fa-lg`}
                                                                                    id="gwt-uid-146"
                                                                                    aria-hidden="true"
                                                                                ></i>
                                                                                ...
                                                                                <span style={{ display: "inline-block" }}>                                                                                   
                                                                                    <br />
                                                                                    <span>
                                                                                    I have verified my service information, and understand I am submitting these documents for SERVICE ONLY, and that they will not be filed with the Court.
                                                                                        <i className="fa fa-asterisk" id="gwt-uid-152" aria-hidden="false" aria-label="Required" style={{ color: "#a94442" }}></i>
                                                                                    </span>
                                                                                </span>
                                                                            </span>
                                                                        </div> */}
                                                                    ...
                                                                    <td colSpan="2" className="text-center">
                                                                        <div className="row d-flex pt-3">
                                                                            <div className="align-self-end ml-auto">
                                                                                <button type="submit" className="col-3 btn btn-default bg-dark text-white me-2" disabled={isSubmitting}>
                                                                                    {isSubmitting ? "Submitting..." : "Submit Service"}
                                                                                </button>
                                                                                {/* <button type="submit" className="col-4 btn btn-default bg-dark text-white me-2"> Submit Service </button> */}
                                                                                <button type="button" className="col-3 btn btn-default bg-dark text-white me-2"> Save Draft </button>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
